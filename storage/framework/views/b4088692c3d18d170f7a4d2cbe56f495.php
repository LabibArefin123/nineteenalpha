...
<?php echo $__env->make('partial.header', ['title' => 'Contact Us'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<!-- Hero Section -->
<section class="relative bg-cover bg-center h-[500px] flex items-center justify-center text-white" style="background-image: url('<?php echo e(asset('images/contacts.png')); ?>')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\tot_nineteenalpha\resources\views/contact.blade.php ENDPATH**/ ?>