...
<div id="about"
     class="py-8 bg-white px-6 md:px-20"
     data-aos="fade-up">

    <div class="max-w-6xl mx-auto text-center">
        
        <div class="text-3xl font-bold mb-6">Our Mission, Vision and Leadership</div>

        
        <div class="text-lg text-gray-700 leading-relaxed mb-6">
            <strong>Nineteen Alpha: Empowering Defence, Defending Future</strong>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8 mt-12 justify-center items-stretch">
            ...
            <div class="flex flex-col bg-white rounded-2xl shadow-lg p-8 text-justify">
                ...
                <p class="text-gray-700 leading-relaxed flex-grow">
                  Founded by a retired colonel of the Bangladesh Armed Forces, Nineteen Alpha serves more than 35 years of military expertise with a forward-thinking approach to defense innovation. Our leadership’s firsthand operational and strategic experience ensures every product and service meets the real- world demands of modern defense.
                </p>
            </div>
        </div>
    </div>
</div>
<?php /**PATH E:\xampp\htdocs\Nineteenalpha\resources\views/partial/about.blade.php ENDPATH**/ ?>