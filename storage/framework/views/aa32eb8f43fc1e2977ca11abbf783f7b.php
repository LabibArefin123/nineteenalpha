<?php $__env->startSection('content'); ?>
    ...
    <div class="relative w-full h-[80vh] sm:h-[60vh] xs:h-[50vh] overflow-hidden">
        <img src="<?php echo e(asset('images/capabilities/weapon/weapon.jpg')); ?>" alt="NineteenAlpha Weapons" class="absolute inset-0 w-full h-full object-cover">
    ...
    <section class="bg-gray-100 py-16 px-4 sm:px-8 lg:px-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-md p-4 sm:p-6 hover:scale-105 transition-transform duration-300">
                <img src="<?php echo e(asset('images/capabilities/weapon/weapon1.JPG')); ?>" alt="Weapon System 1" class="w-full h-48 sm:h-56 object-cover rounded-md">
            ...
            <!-- CARD 2 -->
            <div class="bg-white rounded-xl shadow-md p-4 sm:p-6 hover:scale-105 transition-transform duration-300">
                <img src="<?php echo e(asset('images/capabilities/weapon/weapon2.JPG')); ?>" alt="Weapon System 2" class="w-full h-48 sm:h-56 object-cover rounded-md">
                <div class="pt-4 sm:pt-6 px-2 sm:px-4">
                    <ul class="text-gray-600 text-sm leading-relaxed space-y-2">
            ...
            <!-- CARD 3 -->
            <div class="bg-white rounded-xl shadow-md p-4 sm:p-6 hover:scale-105 transition-transform duration-300">
                <img src="<?php echo e(asset('images/capabilities/weapon/weapon3.jpeg')); ?>" alt="Weapon System 3" class="w-full h-48 sm:h-56 object-cover rounded-md">
                <div class="pt-4 sm:pt-6 px-2 sm:px-4">
                    <ul class="text-gray-600 text-sm leading-relaxed space-y-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\tot_nineteenalpha\resources\views/capability/weapon.blade.php ENDPATH**/ ?>