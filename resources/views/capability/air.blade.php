...
@section('content')
    ...
    <div class="relative w-full h-[80vh] overflow-hidden">
        <img src="{{ asset('images/capabilities/air/air.jpg') }}" alt="NineteenAlpha Air" class="absolute inset-0 w-full h-full object-cover">
    ...
    <section class="bg-gray-100 py-20 px-4 sm:px-8 lg:px-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-md p-6 hover:scale-105 transition transform duration-300">
                <img src="{{ asset('images/capabilities/air/air1.jpg') }}" alt="Subsystem 1" class="w-full h-56 object-cover">
                <div class="py-6 px-4">
            ...
            <!-- CARD 2 -->
            <div class="bg-white rounded-xl shadow-md p-6 hover:scale-105 transition transform duration-300">
                <img src="{{ asset('images/capabilities/air/air2.jpg') }}" alt="Subsystem 1" class="w-full h-56 object-cover">
                <div class="py-6 px-4">
             ...
             <div class="bg-white rounded-xl shadow-md p-6 hover:scale-105 transition transform duration-300">
                <img src="{{ asset('images/capabilities/air/air3.png') }}" alt="Subsystem 1" class="w-full h-56 object-cover">
                <div class="py-6 px-4">
