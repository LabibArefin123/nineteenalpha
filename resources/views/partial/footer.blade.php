    ...
    <div class="grid md:grid-cols-4 gap-12">
        ...
        <div>
            ...
            <ul class="space-y-2">
                ...
                <li><a href="{{ route('about') }}" class="hover:text-red-400">About Us</a></li>
                <li><a href="{{ route('founder_message') }}" class="hover:text-red-400">Founder Message</a></li>
                <li><a href="{{ route('products.index') }}" class="hover:text-red-400">Products</a></li>
                <li><a href="{{ route('capabilities') }}" class="hover:text-red-400">Capabilities</a></li>
                <li><a href="{{ route('contact.index') }}" class="hover:text-red-400">Contact Us</a></li>
            </ul>
        </div>
        <!-- Capabilities -->
        <div>
            ...
            <ul class="space-y-2">
                <li><a href="{{ route('capability.air') }}" class="hover:text-red-400">Air</a></li>
                <li><a href="{{ route('capability.land') }}" class="hover:text-red-400">Land</a></li>
                <li><a href="{{ route('capability.sea') }}" class="hover:text-red-400">Sea</a></li>
                <li><a href="{{ route('capability.weapons') }}" class="hover:text-red-400">Weapons</a></li>
            </ul>
