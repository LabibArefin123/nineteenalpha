...
@section('content')
    ...
    <div class="relative w-full h-[80vh] sm:h-[60vh] xs:h-[50vh] overflow-hidden">
        <img src="{{ asset('images/bgweapons.jpg') }}" alt="NineteenAlpha Weapons" class="absolute inset-0 w-full h-full object-cover">
        <div class="absolute inset-0 bg-black/30 flex flex-col justify-center items-center text-center text-white px-4">
            <h1 class="text-4xl sm:text-5xl font-extrabold tracking-widest mb-4">WEAPON</h1>
            <p class="text-base sm:text-lg font-light max-w-xl sm:max-w-3xl">
    ...
    <section class="bg-gray-100 py-16 px-4 sm:px-8 lg:px-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-md p-4 sm:p-6 hover:scale-105 transition-transform duration-300">
                <img src="{{ asset('images/weapon1.JPG') }}" alt="Weapon System 1" class="w-full h-48 sm:h-56 object-cover rounded-md">
            ...
            <!-- CARD 2 -->
            <div class="bg-white rounded-xl shadow-md p-4 sm:p-6 hover:scale-105 transition-transform duration-300">
                <img src="{{ asset('images/weapon2.JPG') }}" alt="Weapon System 2" class="w-full h-48 sm:h-56 object-cover rounded-md">
                <div class="pt-4 sm:pt-6 px-2 sm:px-4">
                    <ul class="text-gray-600 text-sm leading-relaxed space-y-2">
            ...
            <!-- CARD 3 -->
            <div class="bg-white rounded-xl shadow-md p-4 sm:p-6 hover:scale-105 transition-transform duration-300">
                <img src="{{ asset('images/weapon3.jpeg') }}" alt="Weapon System 3" class="w-full h-48 sm:h-56 object-cover rounded-md">
                <div class="pt-4 sm:pt-6 px-2 sm:px-4">
                    <ul class="text-gray-600 text-sm leading-relaxed space-y-2">
